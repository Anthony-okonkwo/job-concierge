  ...
  useEffect(() => {
    const fetchAnalyticsData = async () => {
      try {
        ...
        // 2. Fetch using dynamic ID and Authorization header
        // Assuming your NestJS endpoint is structured to take the user ID
        const response = await fetch(`${API_BASE_URL}/api/v1/dashboard/analytics/${currentUserId}`, {
          headers: {
        ...
        // GRACEFUL FALLBACK: Skeleton data structure so the UI doesn't crash
        setAnalyticsData({
          kpiData: [
            { title: "Total Applications", value: "0", trend: 0, trendData: [], iconName: "Target" },
            { title: "Interview Rate", value: "0%", trend: 0, trendData: [], iconName: "TrendingUp" },
            { title: "Avg ATS Score", value: "0", trend: 0, trendData: [], iconName: "Award" },
            { title: "Response Time", value: "0d", trend: 0, trendData: [], iconName: "Calendar" },
          ],
          applicationTrend: [],
          statusDistribution: [],
          rolePerformance: [],
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto">
      ...
      >
        ...
        <div className="h-80 flex items-center justify-center">
          {!analyticsData?.applicationTrend || analyticsData.applicationTrend.length === 0 ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        >
          ...
          <div className="h-64 flex items-center justify-center">
            {!analyticsData?.rolePerformance || analyticsData.rolePerformance.length === 0 ? (
