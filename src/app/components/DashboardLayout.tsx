    ...
    return (
      <button
        ...
        className={`w-full flex items-center ${collapsed ? 'justify-center' : 'gap-3'} px-4 py-3 rounded-lg transition-all ${
          active
            ? "bg-[#0275D8] text-white shadow-lg"
  ...
  return (
    <div className="min-h-screen bg-[#F7F9FC] flex flex-col">
            ...
            {currentRole === "admin" && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuItem onClick={() => handleRoleSwitch("staff")}>
                    Staff View
                  </DropdownMenuItem>
      ...
      <div className="flex flex-1">
        {/* Desktop Sidebar */}
        <aside 
          className={`hidden lg:flex lg:flex-col bg-[#0A2342] text-white fixed left-0 h-full z-40 transition-all duration-300 ${
        ...
        >
          ...
          <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            {mainNavItems.map((item) => (
              <NavItem key={item.path} item={item} collapsed={desktopSidebarCollapsed} />
            ))}
          </nav>
          ...
          {sidebarOpen && (
            <>
              ...
              <motion.aside
                ...
                className="fixed left-0 top-0 h-full w-72 bg-[#0A2342] text-white z-50 lg:hidden flex flex-col"
              >
                {/* Logo */}
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      ...
                      className="text-white hover:bg-white/10"
                    >
                      <span className="text-xs capitalize">{currentRole}</span>
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 w-14 h-14 bg-gradient-to-br from-[#0275D8] to-[#00C2D1] rounded-full shadow-lg flex items-center justify-center text-white z-30 hover:shadow-xl transition-shadow"
      >
        <Sparkles className="w-6 h-6" />
      </motion.button>
      ...
      <AnimatePresence>
        {showAIAssistant && (
          <motion.div
            ...
            className="fixed bottom-24 right-8 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-30"
          >
            ...
            <div className="p-4 space-y-3">
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <p className="text-sm text-green-800">
                  <span className="font-semibold">Great news!</span> Your interview rate improved by 12%
                </p>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  Finance roles are performing better than Cloud roles. Consider focusing applications there.
                </p>
              </div>
